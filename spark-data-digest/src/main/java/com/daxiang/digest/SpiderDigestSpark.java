package com.daxiang.digest;

import com.daxiang.digest.configuration.CheckResult;
import com.daxiang.digest.configuration.Common;
import com.daxiang.digest.configuration.ConfigBuilder;
import com.daxiang.digest.configuration.ConfigRuntimeException;
import com.daxiang.digest.framework.*;
import com.daxiang.digest.utils.AsciiArtUtils;
import com.daxiang.digest.utils.CommandLineArgs;
...
public class SpiderDigestSpark {
    ...
    public static void main(String[] args) {
        run("D:\\Users\\zhaozhuo001\\SourceCode\\spark-data-etl\\spark-data-digest\\src\\main\\resources\\example.conf", SPARK, args);
    }
