...
config
    : COMMENT* 'spark' sparkBlock COMMENT* 'input' inputBlock COMMENT* 'transform' filterBlock COMMENT* 'output' outputBlock COMMENT* EOF
    ;
...
// escape character is handled properly.
fragment BSLASH : '\\';
fragment DQUOTE : '"';
fragment SQUOTE : '\'';
